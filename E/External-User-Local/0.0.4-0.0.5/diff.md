# Comparing `tmp/External-User-Local-0.0.4.tar.gz` & `tmp/External-User-Local-0.0.5.tar.gz`
...
## Comparing `External-User-Local-0.0.4.tar` & `External-User-Local-0.0.5.tar`
...
### Comparing `External-User-Local-0.0.4/README.md` & `External-User-Local-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `External-User-Local-0.0.4/db/library_DB.py` & `External-User-Local-0.0.5/db/library_DB.py`

 * *Files identical despite different names*

### Comparing `External-User-Local-0.0.4/setup.py` & `External-User-Local-0.0.5/setup.py`
...
### Comparing `External-User-Local-0.0.4/src/library.py` & `External-User-Local-0.0.5/src/library.py`

 * *Files identical despite different names*

### Comparing `External-User-Local-0.0.4/tests/test_insertExternal.py` & `External-User-Local-0.0.5/tests/test_insertExternal.py`
