# Comparing `tmp/gundi_core-1.0.5.tar.gz` & `tmp/gundi_core-1.1.1.tar.gz`
...
## Comparing `gundi_core-1.0.5.tar` & `gundi_core-1.1.1.tar`
...
### Comparing `gundi_core-1.0.5/gundi_core/schemas/v1.py` & `gundi_core-1.1.1/gundi_core/schemas/v1.py`

 * *Files identical despite different names*

### Comparing `gundi_core-1.0.5/gundi_core/schemas/v2.py` & `gundi_core-1.1.1/gundi_core/schemas/v2.py`
...
### Comparing `gundi_core-1.0.5/PKG-INFO` & `gundi_core-1.1.1/PKG-INFO`
