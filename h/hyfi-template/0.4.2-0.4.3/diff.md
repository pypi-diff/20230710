# Comparing `tmp/hyfi_template-0.4.2.tar.gz` & `tmp/hyfi_template-0.4.3.tar.gz`
...
## Comparing `hyfi_template-0.4.2.tar` & `hyfi_template-0.4.3.tar`
...
### Comparing `hyfi_template-0.4.2/LICENSE` & `hyfi_template-0.4.3/LICENSE`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/README.md` & `hyfi_template-0.4.3/README.md`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/pyproject.toml` & `hyfi_template-0.4.3/pyproject.toml`
...
### Comparing `hyfi_template-0.4.2/src/hyfit/conf/batch/__init__.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/batch/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/src/hyfit/conf/copier/conf.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/copier/conf.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/src/hyfit/conf/dotenv/__init__.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/dotenv/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/src/hyfit/conf/hydra/help/help.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/hydra/help/help.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/src/hyfit/conf/mode/__init__.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/mode/__init__.yaml`
...
### Comparing `hyfi_template-0.4.2/src/hyfit/conf/path/__init__.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/path/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/src/hyfit/conf/project/__init__.yaml` & `hyfi_template-0.4.3/src/hyfit/conf/project/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.2/PKG-INFO` & `hyfi_template-0.4.3/PKG-INFO`
