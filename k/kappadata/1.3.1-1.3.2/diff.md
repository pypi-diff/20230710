# Comparing `tmp/kappadata-1.3.1.tar.gz` & `tmp/kappadata-1.3.2.tar.gz`
...
### Comparing `kappadata-1.3.1/kappadata/utils/magnitude_sampler.py` & `kappadata-1.3.2/kappadata/utils/magnitude_sampler.py`
...
### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/dataset_wrappers/subset_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/dataset_wrappers/subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/mode_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/mode_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py` & `kappadata-1.3.2/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata/wrappers/torch_wrapper.py` & `kappadata-1.3.2/kappadata/wrappers/torch_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/kappadata.egg-info/PKG-INFO` & `kappadata-1.3.2/kappadata.egg-info/PKG-INFO`
...
### Comparing `kappadata-1.3.1/kappadata.egg-info/SOURCES.txt` & `kappadata-1.3.2/kappadata.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.1/setup.cfg` & `kappadata-1.3.2/setup.cfg`
...
### Comparing `kappadata-1.3.1/test_unit_long/test_stochastic_transform_seed.py` & `kappadata-1.3.2/test_unit_long/test_stochastic_transform_seed.py`
