# Comparing `tmp/msgram-parser-0.1.0.tar.gz` & `tmp/msgram-parser-1.0.0.tar.gz`
...
## Comparing `msgram-parser-0.1.0.tar` & `msgram-parser-1.0.0.tar`
...
### Comparing `msgram-parser-0.1.0/LICENSE` & `msgram-parser-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `msgram-parser-0.1.0/PKG-INFO` & `msgram-parser-1.0.0/PKG-INFO`
...
### Comparing `msgram-parser-0.1.0/README.md` & `msgram-parser-1.0.0/README.md`

 * *Files identical despite different names*

### Comparing `msgram-parser-0.1.0/genericparser/genericparser.py` & `msgram-parser-1.0.0/genericparser/genericparser.py`

 * *Files identical despite different names*

### Comparing `msgram-parser-0.1.0/genericparser/plugins/domain/generic_class.py` & `msgram-parser-1.0.0/genericparser/plugins/domain/generic_class.py`

 * *Files identical despite different names*

### Comparing `msgram-parser-0.1.0/genericparser/plugins/statics/sonarqube.py` & `msgram-parser-1.0.0/genericparser/plugins/statics/sonarqube.py`

 * *Files identical despite different names*

### Comparing `msgram-parser-0.1.0/msgram_parser.egg-info/PKG-INFO` & `msgram-parser-1.0.0/msgram_parser.egg-info/PKG-INFO`
...
### Comparing `msgram-parser-0.1.0/msgram_parser.egg-info/SOURCES.txt` & `msgram-parser-1.0.0/msgram_parser.egg-info/SOURCES.txt`
...
@@ -12,9 +12,8 @@
 ...
 msgram_parser.egg-info/requires.txt
 msgram_parser.egg-info/top_level.txt
-tests/test_extract_mettric_sonarqbe.py
 tests/tests_main_file.py
```

### Comparing `msgram-parser-0.1.0/pyproject.toml` & `msgram-parser-1.0.0/pyproject.toml`
