# Comparing `tmp/pyscomotif-0.9.30.tar.gz` & `tmp/pyscomotif-0.9.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyscomotif-0.9.30.tar", last modified: Mon Jul 10 08:54:51 2023, max compression
+gzip compressed data, was "pyscomotif-0.9.9.tar", last modified: Mon Feb 20 09:32:55 2023, max compression
```

## Comparing `pyscomotif-0.9.30.tar` & `pyscomotif-0.9.9.tar`

### file list

```diff
@@ -1,14 +1,13 @@
--rw-r--r--   0        0        0     8495 2023-05-23 13:26:10.772969 pyscomotif-0.9.30/README.md
--rw-r--r--   0        0        0      548 2023-07-10 08:54:44.844299 pyscomotif-0.9.30/pyproject.toml
--rw-r--r--   0        0        0     7115 2023-07-10 08:01:35.677039 pyscomotif-0.9.30/src/pyscomotif/RMSD_calculation.py
--rw-r--r--   0        0        0       88 2023-03-16 13:39:17.205069 pyscomotif-0.9.30/src/pyscomotif/__init__.py
--rw-r--r--   0        0        0     1251 2023-02-20 08:50:03.155529 pyscomotif-0.9.30/src/pyscomotif/constants.py
--rw-r--r--   0        0        0      857 2022-12-21 08:28:41.224270 pyscomotif-0.9.30/src/pyscomotif/data_containers.py
--rw-r--r--   0        0        0     1326 2023-01-27 13:49:21.652224 pyscomotif-0.9.30/src/pyscomotif/index_folders_and_files.py
--rw-r--r--   0        0        0    11831 2023-07-10 08:01:53.436736 pyscomotif-0.9.30/src/pyscomotif/indexing.py
--rw-r--r--   0        0        0    33394 2023-07-09 14:38:00.085231 pyscomotif-0.9.30/src/pyscomotif/motif_search.py
--rw-r--r--   0        0        0    36856 2023-06-12 08:05:15.263113 pyscomotif-0.9.30/src/pyscomotif/motif_search_with_ShareableList.py
--rw-r--r--   0        0        0    13395 2023-07-09 14:29:41.032171 pyscomotif-0.9.30/src/pyscomotif/pyscomotif.py
--rw-r--r--   0        0        0     7377 2023-02-27 14:14:03.695109 pyscomotif-0.9.30/src/pyscomotif/residue_data_dicts.py
--rw-r--r--   0        0        0     4320 2023-05-26 12:22:19.555912 pyscomotif-0.9.30/src/pyscomotif/utils.py
--rw-r--r--   0        0        0     9034 1970-01-01 00:00:00.000000 pyscomotif-0.9.30/PKG-INFO
...
### Comparing `pyscomotif-0.9.30/pyproject.toml` & `pyscomotif-0.9.9/pyproject.toml`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/RMSD_calculation.py` & `pyscomotif-0.9.9/src/pyscomotif/RMSD_calculation.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/constants.py` & `pyscomotif-0.9.9/src/pyscomotif/constants.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.30/src/pyscomotif/data_containers.py` & `pyscomotif-0.9.9/src/pyscomotif/data_containers.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.30/src/pyscomotif/index_folders_and_files.py` & `pyscomotif-0.9.9/src/pyscomotif/index_folders_and_files.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.30/src/pyscomotif/indexing.py` & `pyscomotif-0.9.9/src/pyscomotif/indexing.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/motif_search.py` & `pyscomotif-0.9.9/src/pyscomotif/motif_search_with_ShareableList.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/motif_search_with_ShareableList.py` & `pyscomotif-0.9.9/src/pyscomotif/motif_search.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/pyscomotif.py` & `pyscomotif-0.9.9/src/pyscomotif/pyscomotif.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/residue_data_dicts.py` & `pyscomotif-0.9.9/src/pyscomotif/residue_data_dicts.py`
...
### Comparing `pyscomotif-0.9.30/src/pyscomotif/utils.py` & `pyscomotif-0.9.9/src/pyscomotif/utils.py`
