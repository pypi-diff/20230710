# Comparing `tmp/sWaraNuvad-2.4.0.tar.gz` & `tmp/sWaraNuvad-2.4.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "sWaraNuvad-2.4.0.tar", last modified: Mon Jul 10 06:01:16 2023, max compression
+gzip compressed data, was "sWaraNuvad-2.4.5.tar", last modified: Mon Jul 10 05:22:31 2023, max compression
```

## Comparing `sWaraNuvad-2.4.0.tar` & `sWaraNuvad-2.4.5.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxrwxr-x   0 tejas     (1000) tejas     (1000)        0 2023-07-10 06:01:16.691793 sWaraNuvad-2.4.0/
--rw-rw-r--   0 tejas     (1000) tejas     (1000)     1059 2023-07-10 06:01:16.679793 sWaraNuvad-2.4.0/PKG-INFO
--rw-rw-r--   0 tejas     (1000) tejas     (1000)      974 2023-07-10 05:14:18.000000 sWaraNuvad-2.4.0/README.md
-drwxrwxr-x   0 tejas     (1000) tejas     (1000)        0 2023-07-10 06:01:16.651793 sWaraNuvad-2.4.0/sWaraNuvad/
--rw-rw-r--   0 tejas     (1000) tejas     (1000)     5038 2023-07-07 11:19:34.000000 sWaraNuvad-2.4.0/sWaraNuvad/__init__.py
-drwxrwxr-x   0 tejas     (1000) tejas     (1000)        0 2023-07-10 06:01:16.679793 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/
--rw-rw-r--   0 tejas     (1000) tejas     (1000)     1059 2023-07-10 06:01:16.000000 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/PKG-INFO
--rw-rw-r--   0 tejas     (1000) tejas     (1000)      210 2023-07-10 06:01:16.000000 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/SOURCES.txt
--rw-rw-r--   0 tejas     (1000) tejas     (1000)        1 2023-07-10 06:01:16.000000 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/dependency_links.txt
--rw-rw-r--   0 tejas     (1000) tejas     (1000)       56 2023-07-10 06:01:16.000000 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/requires.txt
--rw-rw-r--   0 tejas     (1000) tejas     (1000)       11 2023-07-10 06:01:16.000000 sWaraNuvad-2.4.0/sWaraNuvad.egg-info/top_level.txt
--rw-rw-r--   0 tejas     (1000) tejas     (1000)       38 2023-07-10 06:01:16.691793 sWaraNuvad-2.4.0/setup.cfg
--rw-rw-r--   0 tejas     (1000) tejas     (1000)     1351 2023-07-10 06:01:06.000000 sWaraNuvad-2.4.0/setup.py
...
### Comparing `sWaraNuvad-2.4.0/PKG-INFO` & `sWaraNuvad-2.4.5/PKG-INFO`
...
### Comparing `sWaraNuvad-2.4.0/README.md` & `sWaraNuvad-2.4.5/README.md`

 * *Files identical despite different names*

### Comparing `sWaraNuvad-2.4.0/sWaraNuvad/__init__.py` & `sWaraNuvad-2.4.5/sWaraNuvad/__init__.py`

 * *Files identical despite different names*

### Comparing `sWaraNuvad-2.4.0/sWaraNuvad.egg-info/PKG-INFO` & `sWaraNuvad-2.4.5/sWaraNuvad.egg-info/PKG-INFO`
...
### Comparing `sWaraNuvad-2.4.0/setup.py` & `sWaraNuvad-2.4.5/setup.py`
