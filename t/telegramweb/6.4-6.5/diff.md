# Comparing `tmp/telegramweb-6.4.tar.gz` & `tmp/telegramweb-6.5.tar.gz`
...
+gzip compressed data, was "dist/telegramweb-6.5.tar", last modified: Mon Jul 10 17:39:00 2023, max compression
```

## Comparing `telegramweb-6.4.tar` & `telegramweb-6.5.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-10 17:39:00.000000 telegramweb-6.5/
+-rw-r--r--   0 runner    (1001) docker     (123)     1062 2023-07-10 17:38:39.000000 telegramweb-6.5/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)       63 2023-07-10 17:38:39.000000 telegramweb-6.5/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)    12446 2023-07-10 17:39:00.000000 telegramweb-6.5/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     9403 2023-07-10 17:38:39.000000 telegramweb-6.5/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-10 17:39:00.000000 telegramweb-6.5/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     1303 2023-07-10 17:38:39.000000 telegramweb-6.5/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-10 17:39:00.000000 telegramweb-6.5/telegram_news/
+-rw-r--r--   0 runner    (1001) docker     (123)      559 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1636 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/constant.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4200 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/displaypolicy.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4944 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/ratelimit.py
+-rw-r--r--   0 runner    (1001) docker     (123)      106 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/table.sql
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-10 17:39:00.000000 telegramweb-6.5/telegram_news/template/
+-rw-r--r--   0 runner    (1001) docker     (123)      391 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/template/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)    44442 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/template/common.py
+-rw-r--r--   0 runner    (1001) docker     (123)    17293 2023-07-10 17:38:39.000000 telegramweb-6.5/telegram_news/utils.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)    12446 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      437 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       66 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       14 2023-07-10 17:39:00.000000 telegramweb-6.5/telegramweb.egg-info/top_level.txt
```

### Comparing `telegramweb-6.4/LICENSE` & `telegramweb-6.5/LICENSE`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/PKG-INFO` & `telegramweb-6.5/PKG-INFO`
...
+Metadata-Version: 2.1 Name: telegramweb Version: 6.5 Summary: Python package
...
### Comparing `telegramweb-6.4/README.md` & `telegramweb-6.5/README.md`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/setup.py` & `telegramweb-6.5/setup.py`
...
### Comparing `telegramweb-6.4/telegram_news/__init__.py` & `telegramweb-6.5/telegram_news/__init__.py`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/telegram_news/constant.py` & `telegramweb-6.5/telegram_news/constant.py`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/telegram_news/displaypolicy.py` & `telegramweb-6.5/telegram_news/displaypolicy.py`
...
### Comparing `telegramweb-6.4/telegram_news/ratelimit.py` & `telegramweb-6.5/telegram_news/ratelimit.py`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/telegram_news/template/common.py` & `telegramweb-6.5/telegram_news/template/common.py`
...
### Comparing `telegramweb-6.4/telegram_news/utils.py` & `telegramweb-6.5/telegram_news/utils.py`

 * *Files identical despite different names*

### Comparing `telegramweb-6.4/telegramweb.egg-info/PKG-INFO` & `telegramweb-6.5/telegramweb.egg-info/PKG-INFO`
