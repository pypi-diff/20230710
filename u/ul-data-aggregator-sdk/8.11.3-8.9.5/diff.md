# Comparing `tmp/ul-data-aggregator-sdk-8.11.3.tar.gz` & `tmp/ul-data-aggregator-sdk-8.9.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ul-data-aggregator-sdk-8.11.3.tar", last modified: Wed Jul  5 08:13:48 2023, max compression
+gzip compressed data, was "ul-data-aggregator-sdk-8.9.5.tar", last modified: Thu Jun 22 13:30:39 2023, max compression
```

## Comparing `ul-data-aggregator-sdk-8.11.3.tar` & `ul-data-aggregator-sdk-8.9.5.tar`

### file list

```diff
@@ -1,47 +1,47 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/
--rw-r--r--   0 root         (0) root         (0)     1604 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/PKG-INFO
--rw-rw-rw-   0 root         (0) root         (0)     1038 2022-01-17 10:15:16.000000 ul-data-aggregator-sdk-8.11.3/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.863491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/
--rw-rw-rw-   0 root         (0) root         (0)      540 2023-03-07 09:36:39.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.863491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__tests__/
--rw-rw-rw-   0 root         (0) root         (0)        0 2023-03-07 09:36:39.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__tests__/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)     1161 2023-04-21 08:06:00.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__tests__/test_integration_message.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.863491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/brokers/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/brokers/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      270 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/brokers/data_aggregator_input_broker.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      297 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/annotations.py
--rw-rw-rw-   0 root         (0) root         (0)     3777 2023-04-10 10:54:49.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/clock_timezones.py
--rw-rw-rw-   0 root         (0) root         (0)    17477 2023-06-15 14:06:50.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/enums.py
--rw-rw-rw-   0 root         (0) root         (0)       38 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/names.py
--rw-rw-rw-   0 root         (0) root         (0)      675 2022-08-07 11:06:43.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/dag.yml
--rw-rw-rw-   0 root         (0) root         (0)    72036 2023-07-05 08:13:43.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/data_aggregator_api_sdk.py
--rw-rw-rw-   0 root         (0) root         (0)      182 2023-06-30 12:04:14.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/data_aggregator_api_sdk_config.py
--rw-rw-rw-   0 root         (0) root         (0)      826 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/data_aggregator_sdk.py
--rw-rw-rw-   0 root         (0) root         (0)       95 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/data_aggregator_sdk_config.py
--rw-rw-rw-   0 root         (0) root         (0)      991 2022-08-17 10:54:58.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/errors.py
--rw-rw-rw-   0 root         (0) root         (0)    28951 2023-07-05 08:13:43.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/integration_message.py
--rw-rw-rw-   0 root         (0) root         (0)      158 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/lib.py
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-25 10:53:31.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/py.typed
--rw-rw-rw-   0 root         (0) root         (0)      152 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/runtime_conf.py
--rw-rw-rw-   0 root         (0) root         (0)      169 2022-08-02 22:29:17.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/self_logging.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-10-12 09:48:10.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)     3200 2023-06-30 12:04:14.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/device.py
--rw-rw-rw-   0 root         (0) root         (0)     3401 2023-06-30 12:04:14.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/get_data_gateway_network_device_list.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/
--rw-rw-rw-   0 root         (0) root         (0)        0 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/__init__.py
--rw-rw-rw-   0 root         (0) root         (0)      257 2022-07-04 09:52:54.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/devices_info_box_to_json.py
--rw-rw-rw-   0 root         (0) root         (0)     1335 2023-06-30 12:04:14.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/internal_api_error_handler.py
--rw-rw-rw-   0 root         (0) root         (0)     1426 2023-06-30 12:04:14.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/internal_api_error_handler_old.py
--rw-rw-rw-   0 root         (0) root         (0)      685 2022-08-02 22:29:17.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/query_params.py
--rw-rw-rw-   0 root         (0) root         (0)      305 2023-04-27 08:59:00.000000 ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/round_dt.py
--rw-r--r--   0 root         (0) root         (0)       38 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/setup.cfg
--rw-rw-rw-   0 root         (0) root         (0)     1464 2023-07-05 08:13:43.000000 ul-data-aggregator-sdk-8.11.3/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-05 08:13:48.867491 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/
--rw-r--r--   0 root         (0) root         (0)     1604 2023-07-05 08:13:48.000000 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)     1544 2023-07-05 08:13:48.000000 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-07-05 08:13:48.000000 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       95 2023-07-05 08:13:48.000000 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       20 2023-07-05 08:13:48.000000 ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/top_level.txt
...
### Comparing `ul-data-aggregator-sdk-8.11.3/PKG-INFO` & `ul-data-aggregator-sdk-8.9.5/PKG-INFO`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/README.md` & `ul-data-aggregator-sdk-8.9.5/README.md`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__init__.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/__init__.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/__tests__/test_integration_message.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/__tests__/test_integration_message.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/clock_timezones.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/constants/clock_timezones.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/constants/enums.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/constants/enums.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/dag.yml` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/dag.yml`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/data_aggregator_sdk.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/data_aggregator_sdk.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/errors.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/errors.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/integration_message.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/integration_message.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/device.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/types/device.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/types/get_data_gateway_network_device_list.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/types/get_data_gateway_network_device_list.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/internal_api_error_handler.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/internal_api_error_handler.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/internal_api_error_handler_old.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/internal_api_error_handler_old.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/data_aggregator_sdk/utils/query_params.py` & `ul-data-aggregator-sdk-8.9.5/data_aggregator_sdk/utils/query_params.py`

 * *Files identical despite different names*

### Comparing `ul-data-aggregator-sdk-8.11.3/setup.py` & `ul-data-aggregator-sdk-8.9.5/setup.py`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/PKG-INFO` & `ul-data-aggregator-sdk-8.9.5/ul_data_aggregator_sdk.egg-info/PKG-INFO`
...
### Comparing `ul-data-aggregator-sdk-8.11.3/ul_data_aggregator_sdk.egg-info/SOURCES.txt` & `ul-data-aggregator-sdk-8.9.5/ul_data_aggregator_sdk.egg-info/SOURCES.txt`
