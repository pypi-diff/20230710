# Comparing `tmp/volt_client_web-0.1.6.tar.gz` & `tmp/volt_client_web-0.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "volt_client_web-0.1.6.tar", max compression
+gzip compressed data, was "volt_client_web-0.1.7.tar", max compression
```

## Comparing `volt_client_web-0.1.6.tar` & `volt_client_web-0.1.7.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     9139 2023-05-12 11:38:50.050175 volt_client_web-0.1.6/README.md
--rw-r--r--   0        0        0      574 2023-06-19 15:40:22.135425 volt_client_web-0.1.6/pyproject.toml
--rw-r--r--   0        0        0      769 2023-05-12 11:38:50.050175 volt_client_web-0.1.6/volt_client_web/__init__.py
--rw-r--r--   0        0        0    11484 2023-05-12 11:38:50.050175 volt_client_web-0.1.6/volt_client_web/crypto_utils.py
--rw-r--r--   0        0        0    22715 2023-06-12 12:53:34.233837 volt_client_web-0.1.6/volt_client_web/volt_client.py
--rw-r--r--   0        0        0     8638 2023-06-19 15:37:37.657103 volt_client_web-0.1.6/volt_client_web/websocket_rpc.py
--rw-r--r--   0        0        0    10168 1970-01-01 00:00:00.000000 volt_client_web-0.1.6/setup.py
--rw-r--r--   0        0        0     9893 1970-01-01 00:00:00.000000 volt_client_web-0.1.6/PKG-INFO
...
### Comparing `volt_client_web-0.1.6/README.md` & `volt_client_web-0.1.7/README.md`

 * *Files identical despite different names*

### Comparing `volt_client_web-0.1.6/pyproject.toml` & `volt_client_web-0.1.7/pyproject.toml`
...
### Comparing `volt_client_web-0.1.6/volt_client_web/__init__.py` & `volt_client_web-0.1.7/volt_client_web/__init__.py`

 * *Files identical despite different names*

### Comparing `volt_client_web-0.1.6/volt_client_web/crypto_utils.py` & `volt_client_web-0.1.7/volt_client_web/crypto_utils.py`

 * *Files identical despite different names*

### Comparing `volt_client_web-0.1.6/volt_client_web/volt_client.py` & `volt_client_web-0.1.7/volt_client_web/volt_client.py`

 * *Files identical despite different names*

### Comparing `volt_client_web-0.1.6/volt_client_web/websocket_rpc.py` & `volt_client_web-0.1.7/volt_client_web/websocket_rpc.py`
...
-                sleep_time = 0.01 # sleep for 10ms after processing received message
...
### Comparing `volt_client_web-0.1.6/setup.py` & `volt_client_web-0.1.7/setup.py`
...
### Comparing `volt_client_web-0.1.6/PKG-INFO` & `volt_client_web-0.1.7/PKG-INFO`
